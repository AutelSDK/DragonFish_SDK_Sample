...
import com.autel.sdksample.base.adapter.BandModeAdapter;
import com.autel.sdksample.base.adapter.BandwidthAdapter;
import com.autel.sdksample.base.adapter.TransferModeAdapter;
...
public class DFDspActivity extends DspActivity {
    CruiserDsp mXStarEvoDsp;
    ...
    protected AutelDsp initController(BaseProduct product) {
        mXStarEvoDsp = ((CruiserAircraft) product).getDsp();
        return mXStarEvoDsp;
    }
